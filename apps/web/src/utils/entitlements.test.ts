...
describe('entitlementsForPlan', () => {
  it('free = one guarded app, free key tier, no deep review, not OEM', () => {
  ...
  it('pro = unlimited guarded apps, pro key tier, deep review, not OEM', () => {
  ...
  it('oem = unlimited guarded apps, oem key tier, deep review, OEM', () => {
