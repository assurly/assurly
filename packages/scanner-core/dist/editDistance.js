...
exports.findNearestCorpusMatch = findNearestCorpusMatch;
/**
...
function damerauLevenshtein(a, b) {
    ...
    if (bLen === 0)
        return aLen;
    const dist = Array.from({ length: aLen + 1 }, () => Array(bLen + 1).fill(0));
 ...
 */
function findNearestCorpusMatch(candidate, corpus, maxDistance = 2) {
