 ...
 */
export declare const HIGH_CONFIDENCE_BLOCKER_RULE_IDS: readonly ["stripe-webhook-signature", "database-migration-safety", "supabase-rls", "supabase-service-role-leak", "public-secret", "stripe-secret-leak", "ai-llm-key-in-client", "database-connection-pooling", "auth-service-role-bypass", "supabase-policy-permissive", "supabase-migration-auth-linked-no-rls", "stripe-live-key-in-dev", "vercel-edge-node-mismatch", "dep-nonexistent-package", "dep-typosquat-suspect", "dep-slopsquat-suspect"];
...
export declare function isHighConfidenceBlockerRuleId(ruleId: string | undefined): boolean;
